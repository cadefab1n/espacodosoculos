...
if (import.meta.env.VITE_FIREBASE_API_KEY) {
  ...
  console.log("Firebase: Environment variables not found, trying fallback JSON");
  try {
    ...
    console.error("Firebase config NOT found! Auth and DB will fail. Check your .env file.");
    config = {
      apiKey: "MISSING",
      projectId: "MISSING"
    };
