...
if (import.meta.env.VITE_FIREBASE_API_KEY) {
  ...
  // Debug log for the user on their VPS (masked for security)
  console.log("Firebase Config Status:", {
    apiKey: config.apiKey ? "LOADED" : "MISSING",
    authDomain: config.authDomain ? "LOADED" : "MISSING",
    projectId: config.projectId ? "LOADED" : "MISSING"
  });
} else {
  ...
  try {
    ...
    console.warn("Firebase config not found. Using empty config fallback.");
    config = {
      apiKey: "MISSING",
      projectId: "MISSING"
    };
