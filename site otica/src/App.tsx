  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (errorCode === 'auth/unauthorized-domain') {
        alert("Domínio não autorizado. Adicione 'espaçodosoculos.com.br' e sua versão punycode nos domínios autorizados do Firebase Console.");
      } else {
        alert(`Erro ao fazer login (${errorCode}). Verifique se você selecionou a conta correta ou se o Firebase está configurado.`);
      }
    }
  };
