...
**⚠️ IMPORTANTE (Domínio com "ç"):**
Como seu domínio contém o caractere "ç", o Firebase exige que você autorize **DOIS** endereços no seu console (Authentication > Settings > Authorized Domains):
1. `espaçodosoculos.com.br`
2. `xn--espaodosoculos-jjb.com.br` (Esta é a versão que o Google entende)

Sem adicionar o segundo item (Punycode), o login sempre falhará com erro de domínio não autorizado.
